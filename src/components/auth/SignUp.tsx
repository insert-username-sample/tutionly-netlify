    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-4 my-4">
          ...
          <span className={`text-xs uppercase font-medium ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1">
            ...
            <Input id="confirm-password" type="password" value={confirmPassword} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setConfirmPassword(e.target.value)} />
          </div>
        </div>
      </CardContent>
